import os
import functools
from flask import Flask, render_template, redirect, url_for, redirect, session, flash, g
from werkzeug.security import generate_password_hash, check_password_hash
from flask_migrate import Migrate # create migration for tables in MySQL
...
def create_app(test_config=None):
    ...
    def require_login(view):
        @functools.wraps(view) # return function that decorates the view
    ...
    def sign_up():
        ...
        return render_template('sign_up.html') # view function
